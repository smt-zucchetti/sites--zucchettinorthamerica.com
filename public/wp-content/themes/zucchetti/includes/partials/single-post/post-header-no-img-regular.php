		  ...
		  <h1 class="entry-title"><?php the_title(); ?></h1>
			...
			<div id="single-below-header" data-hide-on-mobile="<?php echo esc_attr($using_fixed_salient_social); ?>">
				...
				if( '1' !== $remove_single_post_date ) {
					...
					echo '<div class="single--date-wrap">';

						echo '<i class="rk-icon-calendar"></i>';
				...
				echo '<span class="meta-author vcard author">';
					echo '<img src="' . get_avatar_url($author_id) .'" />';
					echo '<span class="fn"><span class="author-leading">' . esc_html__('By', 'salient') . '</span> ' . get_the_author_posts_link() . '</span>';
				echo '</span>';
